...
export const MACHINES: Machine[] = [
  ...
  },
  {
    ...
    keyAdvantages: [
      { fr: 'Nouvelle génération de l\'Alphashot 360', en: 'New generation of Alphashot 360', 'de-ch': 'Neue Generation des Alphashot 360' },
      { fr: 'Éclairage LED amélioré', en: 'Improved LED lighting', 'de-ch': 'Verbesserte LED-Beleuchtung' },
      { fr: 'Interface logicielle modernisée', en: 'Modernized software interface', 'de-ch': 'Modernisierte Software-Oberfläche' },
    ],
    limitations: [
      { fr: 'Poids limité à 3kg', en: 'Weight limited to 3kg', 'de-ch': 'Gewicht auf 3 kg begrenzt' },
    ],
    spaceRequired: 'Bureau',
    studioFootprint: { l: 115, w: 69, h: 64 },
    faqItems: [
      {
        question: { fr: 'Quels types de produits peut-on photographier avec l\'Alphashot G2 ?', en: 'What types of products can be photographed with the Alphashot G2?', 'de-ch': 'Welche Produkttypen lassen sich mit dem Alphashot G2 fotografieren?' },
        answer: { fr: 'L\'Alphashot G2 est la nouvelle generation du studio compact, ideal pour les produits jusqu\'a 30x30x30 cm et 3 kg. Il est particulierement adapte aux chaussures, a la maroquinerie, aux cosmetiques et a l\'electronique. Il produit des packshots, des vues 360 et des videos grace a son eclairage LED ameliore et son interface modernisee.', en: 'The Alphashot G2 is the new generation compact studio, ideal for products up to 30x30x30 cm and 3 kg. It is particularly suited for shoes, leather goods, cosmetics and electronics. It produces packshots, 360 views and videos thanks to its improved LED lighting and modernized interface.', 'de-ch': 'Der Alphashot G2 ist die neue Generation des kompakten Studios, ideal für Produkte bis 30x30x30 cm und 3 kg. Er eignet sich besonders für Schuhe, Lederwaren, Kosmetik und Elektronik. Dank verbesserter LED-Beleuchtung und modernisierter Oberfläche erzeugt er Packshots, 360-Grad-Ansichten und Videos.' },
      },
      {
        question: { fr: 'Quel espace est necessaire pour installer l\'Alphashot G2 ?', en: 'How much space is needed to install the Alphashot G2?', 'de-ch': 'Wie viel Platz wird für die Installation des Alphashot G2 benötigt?' },
        answer: { fr: 'L\'Alphashot G2 ne necessite qu\'un espace bureau. Avec une empreinte de 115x69 cm et une hauteur de 64 cm, il se place sur un bureau ou une table de travail standard. Son installation est immediate, sans travaux ni amenagement specifique requis.', en: 'The Alphashot G2 only requires desk space. With a footprint of 115x69 cm and a height of 64 cm, it sits on a standard desk or work table. Installation is immediate, with no construction work or specific setup required.', 'de-ch': 'Der Alphashot G2 benötigt lediglich Platz auf einem Tisch. Mit einer Stellfläche von 115x69 cm und einer Höhe von 64 cm steht er auf einem Standardtisch oder Arbeitstisch. Die Installation erfolgt sofort, ohne Bauarbeiten oder besondere Einrichtung.' },
      },
      {
        question: { fr: 'Comment se deroule la formation sur l\'Alphashot G2 ?', en: 'How does training on the Alphashot G2 work?', 'de-ch': 'Wie läuft die Schulung zum Alphashot G2 ab?' },
        answer: { fr: 'PackshotCreator assure la formation complete sur l\'Alphashot G2 avec son interface logicielle modernisee. En tant qu\'organisme certifie Qualiopi, la formation est eligible au financement OPCO. Grace a l\'automatisation totale et a l\'interface intuitive de la nouvelle generation, vos equipes sont operationnelles en une demi-journee.', en: 'PackshotCreator provides full training on the Alphashot G2 with its modernized software interface. As a Qualiopi certified organization, training is eligible for OPCO funding. Thanks to full automation and the intuitive new generation interface, your teams are operational in half a day.', 'de-ch': 'PackshotCreator bietet eine umfassende Schulung zum Alphashot G2 mit seiner modernisierten Software-Oberfläche. Dank der vollständigen Automatisierung und der intuitiven Oberfläche der neuen Generation sind Ihre Teams in einem halben Tag einsatzbereit. Eine Schulung ist im Lieferumfang enthalten.' },
      },
      {
        question: { fr: 'Quelles sont les options de financement pour l\'Alphashot G2 ?', en: 'What are the financing options for the Alphashot G2?', 'de-ch': 'Welche Finanzierungsmöglichkeiten gibt es für den Alphashot G2?' },
        answer: { fr: 'L\'Alphashot G2 est disponible en leasing, location avec option d\'achat ou achat direct. Avec une capacite de 200 produits par jour incluant packshot, 360 et video, l\'investissement se rentabilise rapidement. Nos conseillers PackshotCreator vous accompagnent pour definir la formule la plus adaptee a votre activite.', en: 'The Alphashot G2 is available through leasing, rental with purchase option or direct purchase. With a capacity of 200 products per day including packshot, 360 and video, the investment pays for itself quickly. Our PackshotCreator advisors help you find the formula best suited to your business.', 'de-ch': 'Der Alphashot G2 ist per Leasing, Miete mit Kaufoption oder Direktkauf erhältlich. Mit einer Kapazität von 200 Produkten pro Tag inklusive Packshot, 360 und Video amortisiert sich die Investition rasch. Unsere PackshotCreator-Berater helfen Ihnen, die für Ihr Geschäft am besten geeignete Formel zu finden.' },
      },
    ],
    keyStats: [
      { value: '200', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Capacite de production quotidienne tous contenus confondus', en: 'Daily production capacity across all content types', 'de-ch': 'Tägliche Produktionskapazität über alle Inhaltstypen' } },
      { value: '3', label: { fr: 'types de contenu', en: 'content types', 'de-ch': 'Inhaltstypen' }, description: { fr: 'Packshot, 360 et video en un seul studio', en: 'Packshot, 360 and video in one studio', 'de-ch': 'Packshot, 360 und Video in einem einzigen Studio' } },
      { value: '100%', label: { fr: 'automatise', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Automatisation complete avec interface nouvelle generation', en: 'Full automation with new generation interface', 'de-ch': 'Vollständige Automatisierung mit Oberfläche der neuen Generation' } },
    ],
  },
  {
    id: 'alphashot-pro-g2',
