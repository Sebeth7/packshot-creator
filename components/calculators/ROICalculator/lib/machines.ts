...
export const MACHINES: Machine[] = [
  ...
  // ============================================
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: { fr: 'Plusieurs solutions de financement sont disponibles : leasing sur 36 ou 60 mois, location avec option d\'achat, ou acquisition directe. Avec une capacité de 200 produits par jour, le retour sur investissement est généralement atteint en quelques mois pour les entreprises ayant un flux régulier de petits produits à photographier.', en: 'Several financing solutions are available: leasing over 36 or 60 months, rental with purchase option, or direct acquisition. With a capacity of 200 products per day, the return on investment is generally reached within a few months for businesses with a regular flow of small products to photograph.', 'de-ch': 'Mehrere Finanzierungsl\u00F6sungen stehen zur Verf\u00FCgung: Leasing \u00FCber 36 oder 60 Monate, Miete mit Kaufoption oder Direktkauf. Mit einer Kapazit\u00E4t von 200 Produkten pro Tag wird der Return on Investment f\u00FCr Unternehmen mit einem regelm\u00E4ssigen Aufkommen kleiner Produkte in der Regel innerhalb weniger Monate erreicht.' },
      },
    ],
    keyStats: [
      { value: '200', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Capacité de production quotidienne en mode automatisé', en: 'Daily production capacity in automated mode', 'de-ch': 'T\u00E4gliche Produktionskapazit\u00E4t im automatisierten Betrieb' } },
      { value: '360\u00B0', label: { fr: 'rotation produit', en: 'product rotation', 'de-ch': 'Produktrotation' }, description: { fr: 'Vues 360 degrés automatiques pour chaque produit', en: 'Automatic 360-degree views for each product', 'de-ch': 'Automatische 360-Grad-Ansichten f\u00FCr jedes Produkt' } },
      { value: '100%', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Niveau d\'automatisation complet avec IQ Mask et Super Focus', en: 'Full automation level with IQ Mask and Super Focus', 'de-ch': 'Vollst\u00E4ndige Automatisierung mit IQ Mask und Super Focus' } },
    ],
  },
  {
    id: 'alphashot-360',
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: { fr: 'L\'Alphashot 360 est notre solution d\'entrée de gamme avec un excellent rapport qualité-prix. Le financement est possible en leasing, en location avec option d\'achat ou en acquisition directe. Avec 200 produits photographiables par jour, les entreprises constatent un retour sur investissement rapide par rapport à la sous-traitance photo.', en: 'The Alphashot 360 is our entry-level solution with excellent value for money. Financing is available through leasing, rental with purchase option or direct acquisition. With 200 products photographable per day, businesses see a fast return on investment compared to outsourced photography.', 'de-ch': 'Der Alphashot 360 ist unsere Einstiegsl\u00F6sung mit einem ausgezeichneten Preis-Leistungs-Verh\u00E4ltnis. Die Finanzierung ist per Leasing, Miete mit Kaufoption oder Direktkauf m\u00F6glich. Mit 200 fotografierbaren Produkten pro Tag erzielen Unternehmen einen schnellen Return on Investment gegen\u00FCber der Auslagerung der Fotografie.' },
      },
    ],
    keyStats: [
      { value: '200', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Capacité de production quotidienne en automatique', en: 'Daily production capacity in automatic mode', 'de-ch': 'T\u00E4gliche Produktionskapazit\u00E4t im automatischen Betrieb' } },
      { value: '360\u00B0', label: { fr: 'vues interactives', en: 'interactive views', 'de-ch': 'interaktive Ansichten' }, description: { fr: 'Création de vues 360 interactives pour le web', en: 'Creation of interactive 360 views for the web', 'de-ch': 'Erstellung interaktiver 360-Grad-Ansichten f\u00FCr das Web' } },
      { value: '100%', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Automatisation complète de la prise de vue', en: 'Full automation of the shooting process', 'de-ch': 'Vollst\u00E4ndige Automatisierung der Aufnahme' } },
    ],
  },
  {
  ...
  },
  {
    ...
    keyStats: [
      { value: '250', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Capacité de production quotidienne tous contenus confondus', en: 'Daily production capacity across all content types', 'de-ch': 'Tägliche Produktionskapazität über alle Inhaltstypen' } },
      { value: '170', label: { fr: 'panneaux LED', en: 'LED panels', 'de-ch': 'LED-Panels' }, description: { fr: 'Éclairage virtuel piloté par IA', en: 'AI-controlled virtual lighting', 'de-ch': 'KI-gesteuerte virtuelle Beleuchtung' } },
      { value: '25 kg', label: { fr: 'charge max plateau', en: 'max turntable load', 'de-ch': 'max. Drehtellerlast' }, description: { fr: 'Balance et mesure laser intégrées (variante MDC)', en: 'Integrated scale and laser measurement (MDC variant)', 'de-ch': 'Integrierte Waage und Lasermessung (MDC-Variante)' } },
    ],
  },
  {
    id: 'alphashot-pro-g2',
  ...
  // ============================================
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: { fr: 'L\'Alphashot XL v2 est disponible en leasing, location avec option d\'achat ou acquisition directe. Avec 200 produits par jour et la polyvalence pour traiter chaussures, sacs et électronique, il offre un retour sur investissement rapide. Nos commerciaux réalisent une étude personnalisée en fonction de votre volume annuel.', en: 'The Alphashot XL v2 is available through leasing, rental with purchase option or direct acquisition. With 200 products per day and the versatility to handle shoes, bags and electronics, it offers a fast return on investment. Our sales team provides a personalized study based on your annual volume.', 'de-ch': 'Der Alphashot XL v2 ist per Leasing, Miete mit Kaufoption oder Direktkauf erhältlich. Mit 200 Produkten pro Tag und der Vielseitigkeit für Schuhe, Taschen und Elektronik bietet er einen schnellen Return on Investment. Unsere Berater erstellen eine individuelle Analyse auf Basis Ihres Jahresvolumens.' },
      },
    ],
    keyStats: [
      { value: '200', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Capacité de production quotidienne pour produits moyens', en: 'Daily production capacity for medium products', 'de-ch': 'Tägliche Produktionskapazität für mittelgrosse Produkte' } },
      { value: '5', label: { fr: 'caméras simultanées', en: 'simultaneous cameras', 'de-ch': 'gleichzeitige Kameras' }, description: { fr: 'Support multi-caméras pour angles multiples en une seule prise', en: 'Multi-camera support for multiple angles in a single shot', 'de-ch': 'Multikamera-Unterstützung für mehrere Winkel in einer einzigen Aufnahme' } },
      { value: 'Semi', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Semi-automatisation avec contrôle opérateur pour la précision', en: 'Semi-automation with operator control for precision', 'de-ch': 'Teilautomatisierung mit Bedienersteuerung für mehr Präzision' } },
    ],
  },
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: { fr: 'L\'Alphashot XL Wine v2 est disponible en leasing, location ou achat. Pour les domaines viticoles, négociants et caves, avec 200 bouteilles photographiées par jour, l\'investissement est vite rentabilisé face à la sous-traitance photo. Les frais de consommables sont minimes (environ 500 EUR par an) et la maintenance est incluse.', en: 'The Alphashot XL Wine v2 is available through leasing, rental or purchase. For wine estates, merchants and cellars, with 200 bottles photographed per day, the investment quickly pays for itself compared to outsourced photography. Consumable costs are minimal (about 500 EUR per year) and maintenance is included.', 'de-ch': 'Der Alphashot XL Wine v2 ist per Leasing, Miete oder Kauf erh\u00E4ltlich. F\u00FCr Weing\u00FCter, H\u00E4ndler und Kellereien amortisiert sich die Investition mit 200 fotografierten Flaschen pro Tag rasch gegen\u00FCber der Auslagerung der Fotografie. Die Verbrauchskosten sind minimal (rund 500 CHF pro Jahr) und die Wartung ist inbegriffen.' },
      },
    ],
    keyStats: [
      { value: '200', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Bouteilles photographiées par jour en mode automatique', en: 'Bottles photographed per day in automatic mode', 'de-ch': 'Pro Tag im automatischen Betrieb fotografierte Flaschen' } },
      { value: '360\u00B0', label: { fr: 'rotation bouteille', en: 'bottle rotation', 'de-ch': 'Flaschenrotation' }, description: { fr: 'Vue 360 pour montrer toutes les faces de la bouteille et l\'étiquette', en: '360 view to show all sides of the bottle and label', 'de-ch': '360-Grad-Ansicht, um alle Seiten der Flasche und das Etikett zu zeigen' } },
      { value: '100%', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Éclairage et prise de vue entièrement automatisés pour le verre', en: 'Fully automated lighting and shooting for glass', 'de-ch': 'Vollst\u00E4ndig automatisierte Beleuchtung und Aufnahme f\u00FCr Glas' } },
    ],
  },
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: { fr: 'L\'Alphashot XL Pro v2 est disponible en leasing, location avec option d\'achat ou achat direct. La version Pro offre un gain de qualité significatif par rapport au XL standard, particulièrement apprécié par les marques exigeantes. Avec 200 produits par jour et un contrôle qualité optimisé, le retour sur investissement est rapide pour les volumes supérieurs à 5 000 photos par an.', en: 'The Alphashot XL Pro v2 is available through leasing, rental with purchase option or direct purchase. The Pro version offers a significant quality improvement over the standard XL, particularly appreciated by demanding brands. With 200 products per day and optimized quality control, the return on investment is fast for volumes above 5,000 photos per year.', 'de-ch': 'Der Alphashot XL Pro v2 ist per Leasing, Miete mit Kaufoption oder Direktkauf erhältlich. Die Pro-Version bietet einen deutlichen Qualitätsgewinn gegenüber dem Standard-XL, was anspruchsvolle Marken besonders schätzen. Mit 200 Produkten pro Tag und optimierter Qualitätskontrolle ist der Return on Investment bei Volumen über 5 000 Fotos pro Jahr schnell erreicht.' },
      },
    ],
    keyStats: [
      { value: '200', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Capacité de production quotidienne en qualité Pro', en: 'Daily production capacity in Pro quality', 'de-ch': 'Tägliche Produktionskapazität in Pro-Qualität' } },
      { value: '5', label: { fr: 'caméras simultanées', en: 'simultaneous cameras', 'de-ch': 'gleichzeitige Kameras' }, description: { fr: 'Contrôle multi-caméras pour angles multiples', en: 'Multi-camera control for multiple angles', 'de-ch': 'Multikamera-Steuerung für mehrere Blickwinkel' } },
      { value: '100%', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Automatisation complète avec éclairages coulissants et laser', en: 'Full automation with sliding lights and laser', 'de-ch': 'Vollständige Automatisierung mit verschiebbarer Beleuchtung und Laser' } },
    ],
  },
  ...
  // ============================================
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: { fr: 'L\'Alphadesk v2 est finançable en leasing, location ou achat direct. Avec 480 produits par jour, c\'est l\'une des machines les plus productives de la gamme. Pour les enseignes de mode ou les marques textiles avec de gros volumes de références, le retour sur investissement est particulièrement rapide par rapport à un studio photo traditionnel.', en: 'The Alphadesk v2 can be financed through leasing, rental or direct purchase. With 480 products per day, it is one of the most productive machines in the range. For fashion retailers or textile brands with large volumes of references, the return on investment is particularly fast compared to a traditional photo studio.', 'de-ch': 'Der Alphadesk v2 ist per Leasing, Miete oder Direktkauf finanzierbar. Mit seinem hohen Durchsatz pro Tag zählt er zu den produktivsten Maschinen der Reihe. Für Modehändler oder Textilmarken mit grossen Artikelmengen ist der Return on Investment im Vergleich zu einem klassischen Fotostudio besonders schnell erreicht.' },
      },
    ],
    keyStats: [
      { value: '300', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Solution rapide et spécialisée pour le textile à plat', en: 'Fast and specialized solution for flat textiles', 'de-ch': 'Schnelle, spezialisierte Lösung für liegende Textilien' } },
      { value: '2D', label: { fr: 'flat-lay spécialisé', en: 'specialized flat-lay', 'de-ch': 'spezialisiertes Flat-Lay' }, description: { fr: 'Vue de dessus optimisée pour vêtements et accessoires', en: 'Top-down view optimized for clothing and accessories', 'de-ch': 'Für Kleidung und Accessoires optimierte Draufsicht' } },
      { value: 'Semi', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Semi-automatisation avec boutons de capture instantanée', en: 'Semi-automation with instant capture buttons', 'de-ch': 'Teilautomatisierung mit Sofortauslösern' } },
    ],
  },
  {
    id: 'alphatable',
    ...
    faqItems: [
      {
        ...
        answer: { fr: 'L\'Alphatable v2 est le studio flat-lay grand format, capable de photographier des produits jusqu\'à 165x112 cm et 80 kg. Il est idéal pour les grands vêtements (manteaux, robes, pantalons dépliés), les tapis, les carrelages, les tissus d\'ameublement et tous les articles de grande surface à photographier à plat. Avec 500 produits par jour, c\'est la machine la plus productive de la gamme.', en: 'The Alphatable v2 is the large-format flat-lay studio, capable of photographing products up to 165x112 cm and 80 kg. It is ideal for large garments (coats, dresses, unfolded trousers), carpets, tiles, upholstery fabrics and all large surface items to photograph flat. With 500 products per day, it is the most productive machine in the range.', 'de-ch': 'Der Alphatable v2 ist das grossformatige Flat-Lay-Studio und kann Produkte bis 165x112 cm und 80 kg fotografieren. Er eignet sich ideal für grosse Kleidungsstücke (Mäntel, Kleider, ausgebreitete Hosen), Teppiche, Fliesen, Möbelstoffe und alle grossflächigen Artikel, die flach fotografiert werden. Mit hohem Durchsatz pro Tag ist er die produktivste Maschine der Reihe.' },
      },
      {
        question: { fr: 'Quel espace est nécessaire pour installer l\'Alphatable v2 ?', en: 'How much space is needed to install the Alphatable v2?', 'de-ch': 'Wie viel Platz wird für die Installation des Alphatable v2 benötigt?' },
        answer: { fr: 'L\'Alphatable v2 est un équipement au sol imposant avec une empreinte de 338x191 cm et une hauteur de 268 cm. Prévoyez un espace dédié d\'environ 8 à 10 m2 pour l\'installation et la circulation autour de la table. La hauteur sous plafond doit être d\'au moins 3 mètres. C\'est un investissement en espace justifié par la productivité exceptionnelle.', en: 'The Alphatable v2 is a large floor-standing piece of equipment with a footprint of 338x191 cm and a height of 268 cm. Plan for a dedicated space of about 8 to 10 sqm for installation and circulation around the table. Ceiling height must be at least 3 meters. It\'s a space investment justified by exceptional productivity.', 'de-ch': 'Der Alphatable v2 ist ein imposantes bodenstehendes Gerät mit einer Stellfläche von 338x191 cm und einer Höhe von 268 cm. Planen Sie rund 8 bis 10 m2 für die Installation und die Bewegung rund um den Tisch ein. Die Raumhöhe muss mindestens 3 Meter betragen. Diese Platzinvestition wird durch die aussergewöhnliche Produktivität gerechtfertigt.' },
      },
      {
        question: { fr: 'Comment se déroule la formation sur l\'Alphatable v2 ?', en: 'How does training on the Alphatable v2 work?', 'de-ch': 'Wie läuft die Schulung zum Alphatable v2 ab?' },
        answer: { fr: 'La formation PackshotCreator sur l\'Alphatable v2 inclut le guidage laser, le zoom motorisé et les techniques de mise à plat grand format. Notre certification Qualiopi permet la prise en charge financière par votre OPCO. Comptez une journée de formation pour exploiter pleinement les capacités de l\'équipement, y compris les automatismes de prise de vue en série.', en: 'PackshotCreator training on the Alphatable v2 includes laser guidance, motorized zoom and large-format flat-lay techniques. Our Qualiopi certification allows financial coverage by your OPCO. Allow one day of training to fully leverage the equipment\'s capabilities, including batch shooting automation.', 'de-ch': 'Die PackshotCreator-Schulung zum Alphatable v2 umfasst die Laserführung, den motorisierten Zoom und die Techniken zum flachen Auslegen im Grossformat. Rechnen Sie mit einem Schulungstag, um die Möglichkeiten des Geräts voll auszuschöpfen, einschliesslich der Automatik für Serienaufnahmen. Eine Schulung ist im Lieferumfang enthalten.' },
      },
      {
        ...
        answer: { fr: 'L\'Alphatable v2 est finançable en leasing, location avec option d\'achat ou acquisition directe. Avec 500 produits par jour et la capacité de traiter des articles de grande taille, c\'est un outil de production à haut rendement. Pour les enseignes textiles ou les fabricants de revêtements avec plus de 5 000 références par an, le ROI est généralement atteint en moins d\'un an.', en: 'The Alphatable v2 can be financed through leasing, rental with purchase option or direct acquisition. With 500 products per day and the ability to handle large items, it is a high-throughput production tool. For textile retailers or covering manufacturers with more than 5,000 references per year, ROI is generally achieved in less than one year.', 'de-ch': 'Der Alphatable v2 ist per Leasing, Miete mit Kaufoption oder Direktkauf finanzierbar. Mit hohem Durchsatz pro Tag und der Fähigkeit, grossformatige Artikel zu verarbeiten, ist er ein Produktionswerkzeug mit hoher Leistung. Für Textilhändler oder Belaghersteller mit über 5 000 Artikeln pro Jahr wird der ROI in der Regel in weniger als einem Jahr erreicht.' },
      },
    ],
    keyStats: [
      { value: '300', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Studio flat-lay grand format haute productivité', en: 'High-productivity large-format flat-lay studio', 'de-ch': 'Hochproduktives Flat-Lay-Studio im Grossformat' } },
      { value: '165cm', label: { fr: 'surface max', en: 'max surface', 'de-ch': 'max. Fläche' }, description: { fr: 'Plan de travail de 165x112 cm pour grands vêtements et tissus', en: 'Work surface of 165x112 cm for large garments and fabrics', 'de-ch': 'Arbeitsfläche von 165x112 cm für grosse Kleidungsstücke und Stoffe' } },
      { value: '100%', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Automatisation complète avec guidage laser et zoom motorisé', en: 'Full automation with laser guidance and motorized zoom', 'de-ch': 'Vollständige Automatisierung mit Laserführung und motorisiertem Zoom' } },
    ],
  },
  ...
  },
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: { fr: 'L\'Alphastudio XXL Pro v2 est finançable en leasing, location ou achat direct. C\'est un investissement stratégique pour les entreprises de mode et de retail ayant un gros volume. Avec 150 produits par jour et 5 types de contenu différents, il remplace à lui seul un studio photo complet, offrant un retour sur investissement attractif pour les volumes supérieurs à 15 000 photos par an.', en: 'The Alphastudio XXL Pro v2 can be financed through leasing, rental or direct purchase. It is a strategic investment for fashion and retail businesses with high volume. With 150 products per day and 5 different content types, it single-handedly replaces a complete photo studio, offering an attractive return on investment for volumes above 15,000 photos per year.', 'de-ch': 'Der Alphastudio XXL Pro v2 ist per Leasing, Miete oder Direktkauf finanzierbar. Er ist eine strategische Investition für Mode- und Retail-Unternehmen mit hohem Volumen. Mit 150 Produkten pro Tag und 5 verschiedenen Inhaltstypen ersetzt er im Alleingang ein komplettes Fotostudio und bietet einen attraktiven Return on Investment bei Volumen über 15 000 Fotos pro Jahr.' },
      },
    ],
    keyStats: [
      { value: '150', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Capacité de production quotidienne tous types de contenu', en: 'Daily production capacity across all content types', 'de-ch': 'Tägliche Produktionskapazität über alle Inhaltstypen' } },
      { value: '5', label: { fr: 'types de contenu', en: 'content types', 'de-ch': 'Inhaltstypen' }, description: { fr: 'Packshot, 360, vidéo, ghost mannequin et lifestyle', en: 'Packshot, 360, video, ghost mannequin and lifestyle', 'de-ch': 'Packshot, 360, Video, Ghost-Mannequin und Lifestyle' } },
      { value: '100%', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Automatisation complète avec détourage IQ-Mask intégré', en: 'Full automation with integrated IQ-Mask clipping', 'de-ch': 'Vollständige Automatisierung mit integriertem IQ-Mask-Freistellen' } },
    ],
  },
  ...
  // ============================================
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: { fr: 'Le Fashion Studio Basic est finançable en leasing, location avec option d\'achat ou acquisition directe. C\'est le point d\'entrée de la gamme Fashion, offrant un excellent rapport qualité-prix pour les marques de mode. Avec 80 produits par jour et 5 types de contenu, il permet de remplacer la sous-traitance photo mode et d\'obtenir un retour sur investissement significatif.', en: 'The Fashion Studio Basic can be financed through leasing, rental with purchase option or direct acquisition. It is the entry point of the Fashion range, offering excellent value for fashion brands. With 80 products per day and 5 content types, it allows replacing outsourced fashion photography and achieving a significant return on investment.', 'de-ch': 'Das Fashion Studio Basic ist per Leasing, Miete mit Kaufoption oder Direktkauf finanzierbar. Es ist der Einstieg in die Fashion-Reihe und bietet Modemarken ein ausgezeichnetes Preis-Leistungs-Verhältnis. Mit 80 Produkten pro Tag und 5 Inhaltstypen ersetzt es die Auslagerung der Modefotografie und erzielt einen deutlichen Return on Investment.' },
      },
    ],
    keyStats: [
      { value: '80', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Capacité de production quotidienne en mode fashion', en: 'Daily production capacity in fashion mode', 'de-ch': 'Tägliche Produktionskapazität im Fashion-Modus' } },
      { value: '5', label: { fr: 'types de contenu', en: 'content types', 'de-ch': 'Inhaltstypen' }, description: { fr: 'Packshot, 360, vidéo, ghost mannequin et lifestyle', en: 'Packshot, 360, video, ghost mannequin and lifestyle', 'de-ch': 'Packshot, 360, Video, Ghost-Mannequin und Lifestyle' } },
      { value: 'Semi', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Semi-automatisation adaptée aux prises avec mannequins vivants', en: 'Semi-automation adapted for live model shoots', 'de-ch': 'Teilautomatisierung, angepasst an Aufnahmen mit lebenden Models' } },
    ],
  },
  {
    id: 'fashion-studio',
    ...
    faqItems: [
      {
        ...
        answer: { fr: 'Le Fashion Studio Pro v2 est la référence pour la photographie de mode professionnelle. Avec un espace scénique de 3x3m, il accueille mannequins vivants, vêtements portés, vidéos de défilé et stylisme complet. Il intègre un miroir virtuel pour le modèle, des Kick lights pour les effets de mode et produit les 5 types de contenu : packshot, 360, vidéo, ghost mannequin et lifestyle.', en: 'The Fashion Studio Pro v2 is the reference for professional fashion photography. With a 3x3m stage space, it accommodates live models, worn clothing, runway videos and complete styling. It integrates a virtual mirror for the model, Kick lights for fashion effects and produces all 5 content types: packshot, 360, video, ghost mannequin and lifestyle.', 'de-ch': 'Das Fashion Studio Pro v2 ist die Referenz für die professionelle Modefotografie. Mit einem Bühnenbereich von 3x3 m nimmt es lebende Models, getragene Kleidung, Laufsteg-Videos und komplettes Styling auf. Es integriert einen virtuellen Spiegel für das Model, Kick-Lights für Modeeffekte und erzeugt alle 5 Inhaltstypen: Packshot, 360, Video, Ghost-Mannequin und Lifestyle.' },
      },
      {
        question: { fr: 'Quel espace est nécessaire pour installer le Fashion Studio Pro v2 ?', en: 'How much space is needed to install the Fashion Studio Pro v2?', 'de-ch': 'Wie viel Platz wird für die Installation des Fashion Studio Pro v2 benötigt?' },
        answer: { fr: 'Le Fashion Studio Pro v2 est un équipement majeur avec une empreinte de 847x301 cm et une hauteur de 292 cm. Il nécessite un très grand studio dédié de plus de 30 m2 avec une hauteur sous plafond d\'au moins 3 mètres. L\'espace doit inclure les zones de circulation des mannequins, l\'espace scénique de 3x3m et les zones techniques.', en: 'The Fashion Studio Pro v2 is a major piece of equipment with a footprint of 847x301 cm and a height of 292 cm. It requires a very large dedicated studio of over 30 sqm with a ceiling height of at least 3 meters. The space must include model circulation areas, the 3x3m stage space and technical areas.', 'de-ch': 'Das Fashion Studio Pro v2 ist ein bedeutendes Gerät mit einer Stellfläche von 847x301 cm und einer Höhe von 292 cm. Es benötigt ein sehr grosses, eigenes Studio von über 30 m2 mit einer Raumhöhe von mindestens 3 Metern. Der Raum muss die Bewegungszonen der Models, den Bühnenbereich von 3x3 m und die technischen Zonen umfassen.' },
      },
      {
        question: { fr: 'Comment se déroule la formation sur le Fashion Studio Pro v2 ?', en: 'How does training on the Fashion Studio Pro v2 work?', 'de-ch': 'Wie läuft die Schulung zum Fashion Studio Pro v2 ab?' },
        answer: { fr: 'La formation PackshotCreator sur le Fashion Studio Pro v2 est la plus complète de notre offre. Elle couvre le miroir virtuel, les Kick lights, la gestion des mannequins vivants, les 5 types de contenu et les workflows de post-production. Finançable par votre OPCO grâce à notre certification Qualiopi, prévoyez trois journées pour une maîtrise complète.', en: 'PackshotCreator training on the Fashion Studio Pro v2 is the most comprehensive in our offering. It covers the virtual mirror, Kick lights, live model management, all 5 content types and post-production workflows. Fundable by your OPCO thanks to our Qualiopi certification, allow three days for complete mastery.', 'de-ch': 'Die PackshotCreator-Schulung zum Fashion Studio Pro v2 ist die umfassendste unseres Angebots. Sie deckt den virtuellen Spiegel, die Kick-Lights, den Umgang mit lebenden Models, die 5 Inhaltstypen und die Post-Production-Workflows ab. Rechnen Sie mit drei Tagen für eine vollständige Beherrschung. Eine Schulung ist im Lieferumfang enthalten.' },
      },
      {
        ...
        answer: { fr: 'Le Fashion Studio Pro v2 est un investissement premium finançable en leasing, location ou achat direct. Pour les maisons de mode, les agences et les grands retailers traitant plus de 15 000 photos par an, il remplace un studio photo traditionnel avec équipe technique. Le gain de productivité (100 produits/jour) et la qualité constante offrent un ROI significatif sur 3 à 5 ans.', en: 'The Fashion Studio Pro v2 is a premium investment available through leasing, rental or direct purchase. For fashion houses, agencies and large retailers processing more than 15,000 photos per year, it replaces a traditional photo studio with technical crew. The productivity gain (100 products/day) and consistent quality offer a significant ROI over 3 to 5 years.', 'de-ch': 'Das Fashion Studio Pro v2 ist eine Premium-Investition, die per Leasing, Miete oder Direktkauf erhältlich ist. Für Modehäuser, Agenturen und grosse Retailer, die mehr als 15 000 Fotos pro Jahr verarbeiten, ersetzt es ein klassisches Fotostudio mit technischem Team. Der Produktivitätsgewinn (100 Produkte/Tag) und die konstante Qualität bieten einen deutlichen ROI über 3 bis 5 Jahre.' },
      },
    ],
    keyStats: [
      { value: '100', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Capacité de production quotidienne en mode fashion professionnel', en: 'Daily production capacity in professional fashion mode', 'de-ch': 'Tägliche Produktionskapazität im professionellen Fashion-Modus' } },
      { value: '3x3m', label: { fr: 'espace scénique', en: 'stage space', 'de-ch': 'Bühnenbereich' }, description: { fr: 'Espace scénique de 9 m2 pour mannequins vivants et styling', en: '9 sqm stage space for live models and styling', 'de-ch': 'Bühnenbereich von 9 m2 für lebende Models und Styling' } },
      { value: 'Semi', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Semi-automatisation avec outils d\'interaction mannequin', en: 'Semi-automation with model interaction tools', 'de-ch': 'Teilautomatisierung mit Werkzeugen zur Model-Interaktion' } },
    ],
  },
  {
    id: 'bike-studio',
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: { fr: 'Le Bike Studio est finançable en leasing, location avec option d\'achat ou acquisition directe. Pour les fabricants de vélos, les distributeurs et les plateformes e-commerce cycles traitant plus de 3 000 références par an, il représente un investissement stratégique. Les 70 vélos par jour et la qualité constante garantissent un retour sur investissement solide face à la sous-traitance photo spécialisée.', en: 'The Bike Studio can be financed through leasing, rental with purchase option or direct acquisition. For bike manufacturers, distributors and cycle e-commerce platforms processing more than 3,000 references per year, it represents a strategic investment. The 70 bikes per day and consistent quality guarantee a solid return on investment versus outsourced specialized photography.', 'de-ch': 'Das Bike Studio ist per Leasing, Miete mit Kaufoption oder Direktkauf finanzierbar. Für Fahrradhersteller, Distributoren und E-Commerce-Plattformen für Zweiräder mit über 3 000 Artikeln pro Jahr ist es eine strategische Investition. Die 70 Fahrräder pro Tag und die konstante Qualität garantieren einen soliden Return on Investment gegenüber der ausgelagerten Spezialfotografie.' },
      },
    ],
    keyStats: [
      { value: '70', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Vélos photographiés par jour en mode automatisé', en: 'Bikes photographed per day in automated mode', 'de-ch': 'Pro Tag im automatisierten Betrieb fotografierte Fahrräder' } },
      { value: '190K', label: { fr: 'lumens', en: 'lumens', 'de-ch': 'Lumen' }, description: { fr: '12 panneaux LED totalisant 190 000 lumens pour un éclairage parfait', en: '12 LED panels totaling 190,000 lumens for perfect lighting', 'de-ch': '12 LED-Panels mit insgesamt 190 000 Lumen für eine perfekte Ausleuchtung' } },
      { value: '100%', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Automatisation complète avec suspension et rotation spécialisées', en: 'Full automation with specialized suspension and rotation', 'de-ch': 'Vollständige Automatisierung mit spezialisierter Aufhängung und Rotation' } },
    ],
  },
  {
    id: 'furniture-studio',
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: { fr: 'Le Furniture Studio est finançable en leasing, location ou achat direct. C\'est un investissement majeur justifié par le coût élevé de la photo de mobilier en sous-traitance. Avec 60 meubles par jour et une qualité constante, les fabricants et distributeurs de mobilier traitant plus de 2 000 références par an constatent un retour sur investissement solide sur 2 à 3 ans.', en: 'The Furniture Studio can be financed through leasing, rental or direct purchase. It is a major investment justified by the high cost of outsourced furniture photography. With 60 pieces of furniture per day and consistent quality, furniture manufacturers and distributors processing more than 2,000 references per year see a solid return on investment over 2 to 3 years.', 'de-ch': 'Das Furniture Studio ist per Leasing, Miete oder Direktkauf finanzierbar. Es ist eine bedeutende Investition, die durch die hohen Kosten der ausgelagerten Möbelfotografie gerechtfertigt wird. Mit 60 Möbeln pro Tag und konstanter Qualität erzielen Möbelhersteller und -distributoren mit über 2 000 Artikeln pro Jahr einen soliden Return on Investment über 2 bis 3 Jahre.' },
      },
    ],
    keyStats: [
      { value: '60', label: { fr: 'produits/jour', en: 'products/day', 'de-ch': 'Produkte/Tag' }, description: { fr: 'Meubles photographiés par jour en automatique complet', en: 'Furniture pieces photographed per day in fully automatic mode', 'de-ch': 'Pro Tag im vollautomatischen Betrieb fotografierte Möbel' } },
      { value: '500kg', label: { fr: 'charge max', en: 'max load', 'de-ch': 'max. Last' }, description: { fr: 'Plateau tournant haute capacité pour mobilier lourd', en: 'High-capacity turntable for heavy furniture', 'de-ch': 'Drehteller mit hoher Tragfähigkeit für schwere Möbel' } },
      { value: '100%', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Automatisation complète pour production en série de mobilier', en: 'Full automation for furniture batch production', 'de-ch': 'Vollständige Automatisierung für die Serienproduktion von Möbeln' } },
    ],
  },
  {
    ...
    faqItems: [
      {
        ...
        answer: { fr: 'L\'E-Comm Studio+ est la solution ultime pour les très grands produits jusqu\'à 300x300x200 cm : canapés, meubles volumineux, motos, électroménager lourd et tout produit XXL. Son plateau rotatif de 5 mètres de diamètre supporte 1 tonne (option 4 tonnes). Il produit des packshots, des vues 360 et des vidéos de qualité e-commerce pour les objets les plus imposants.', en: 'The E-Comm Studio+ is the ultimate solution for very large products up to 300x300x200 cm: sofas, bulky furniture, motorcycles, heavy appliances and any XXL product. Its 5-meter diameter rotating platform supports 1 ton (4-ton option). It produces packshots, 360 views and e-commerce quality videos for the most imposing objects.', 'de-ch': 'Das E-Comm Studio+ ist die ultimative Lösung für sehr grosse Produkte bis 300x300x200 cm: Sofas, sperrige Möbel, Motorräder, schwere Haushaltsgeräte und jedes XXL-Produkt. Seine Drehplattform mit 5 Metern Durchmesser trägt 1 Tonne (Option 4 Tonnen). Es erzeugt Packshots, 360-Grad-Ansichten und Videos in E-Commerce-Qualität für die imposantesten Objekte.' },
      },
      {
        question: { fr: 'Quel espace est nécessaire pour installer l\'E-Comm Studio+ ?', en: 'How much space is needed to install the E-Comm Studio+?', 'de-ch': 'Wie viel Platz wird für die Installation des E-Comm Studio+ benötigt?' },
        answer: { fr: 'L\'E-Comm Studio+ nécessite un entrepôt avec une empreinte de 670x588 cm et une hauteur de 302 cm. Prévoyez un espace d\'environ 40 à 50 m2 avec une alimentation électrique de 9000W, un sol industriel renforcé pour supporter le plateau de 1 tonne et un accès pour véhicules et chariots élévateurs. C\'est une installation industrielle à part entière.', en: 'The E-Comm Studio+ requires a warehouse with a footprint of 670x588 cm and a height of 302 cm. Plan for a space of about 40 to 50 sqm with a 9000W electrical supply, reinforced industrial flooring to support the 1-ton platform and access for vehicles and forklifts. It is a full-scale industrial installation.', 'de-ch': 'Das E-Comm Studio+ benötigt eine Lagerhalle mit einer Stellfläche von 670x588 cm und einer Höhe von 302 cm. Planen Sie rund 40 bis 50 m2 mit einer Stromversorgung von 9000 W, einem verstärkten Industrieboden zum Tragen der 1-Tonnen-Plattform und Zugang für Fahrzeuge und Gabelstapler ein. Es handelt sich um eine vollwertige industrielle Installation.' },
      },
      {
        question: { fr: 'Comment se déroule la formation sur l\'E-Comm Studio+ ?', en: 'How does training on the E-Comm Studio+ work?', 'de-ch': 'Wie läuft die Schulung zum E-Comm Studio+ ab?' },
        answer: { fr: 'La formation PackshotCreator sur l\'E-Comm Studio+ est la plus avancée de notre offre. Elle couvre la gestion du plateau 5m, les protocoles de sécurité pour produits lourds, l\'optimisation de l\'éclairage pour grands volumes et les workflows de production en série. Finançable par votre OPCO via notre certification Qualiopi, prévoyez deux à trois journées de formation.', en: 'PackshotCreator training on the E-Comm Studio+ is the most advanced in our offering. It covers management of the 5m platform, safety protocols for heavy products, lighting optimization for large volumes and batch production workflows. Fundable by your OPCO through our Qualiopi certification, allow two to three days of training.', 'de-ch': 'Die PackshotCreator-Schulung zum E-Comm Studio+ ist die fortgeschrittenste unseres Angebots. Sie deckt die Steuerung der 5-m-Plattform, die Sicherheitsprotokolle für schwere Produkte, die Optimierung der Beleuchtung für grosse Volumen und die Workflows der Serienproduktion ab. Rechnen Sie mit zwei bis drei Schulungstagen. Eine Schulung ist im Lieferumfang enthalten.' },
      },
      {
    ...
    keyStats: [
      ...
      { value: '100%', label: { fr: 'automatisé', en: 'automated', 'de-ch': 'automatisiert' }, description: { fr: 'Automatisation complète avec plateforme industrielle 5m', en: 'Full automation with 5m industrial platform', 'de-ch': 'Vollständige Automatisierung mit industrieller 5-m-Plattform' } },
    ],
  },
];
