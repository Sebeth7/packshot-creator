...
export const MACHINES: Machine[] = [
  ...
  // ============================================
  {
    ...
    keyStats: [
      { value: '480', label: { fr: 'produits/jour', en: 'products/day' }, description: { fr: 'La machine la plus rapide de la gamme pour le textile a plat', en: 'The fastest machine in the range for flat textiles' } },
  ...
  },
  {
    ...
    keyStats: [
      { value: '500', label: { fr: 'produits/jour', en: 'products/day' }, description: { fr: 'La machine la plus productive de toute la gamme Orbitvu', en: 'The most productive machine in the entire Orbitvu range' } },
