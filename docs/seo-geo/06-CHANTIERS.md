...
| Commit | `0e8949f` |
| Zone | Orange — c'est Sébastien qui merge |
...
| Zone | Infrastructure — voir `05-INFRA.md` |
...
| Zone | Rouge pour le code — analyse autorisée |
...
Toute proposition de correctif dans `next.config.ts` passe par
...
| Zone | Orange — création de page, copy par Sébastien |
...
| Calculateur ROI, questionnaire client | Sébastien | Zone rouge |
