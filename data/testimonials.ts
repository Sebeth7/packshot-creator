...
export const testimonials: Testimonial[] = [
  ...
  {
    id: 'jacques-viallon-2014-05',
    name: 'Jacques Viallon Photographe',
    rating: 5,
    dateRelative: 'il y a 12 ans',
    dateISO: '2014-05-08',
    text: "En tant que photographe professionnel, je suis toujours à la recherche d'outils de pointe et performants. Avec le matériel de Packshot Creator, j'ai entre les mains du matériel de très haute gamme. La conception de ce matériel est étudiée.",
    sourceUrl: GMB_URL,
    categories: ['general', 'studios'],
    isLocalGuide: true,
  },
